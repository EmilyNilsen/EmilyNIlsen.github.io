  ...
  return(
    ...
    <section className='container-contact '>
      <di className='container-icons'>
        ...
        <i><AiOutlineLinkedin size='1.5rem'/></i>
        <i><AiFillGithub size='1.5rem' /></i>
      </di>
      <div className='container-infos'>
        <p>Emily Nilsen Carvalho</p>
        <a href='https://www.linkedin.com/in/emily-nilsen-carvalho/' target="_blank" rel="noreferrer">Linkedin</a>
        <a href='https://github.com/EmilyNilsen' target="_blank" rel="noreferrer">Repositório Github</a>
      </div>
    </section>
    </section>
    </>
